...
namespace SF.IY.InsurancePolicy.DemoAPI.BackgroundServices;
...
public class InsurancePolicyEventsMessageService : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += (ch, e) =>
        {
            ...
            _logger.LogDebug($"Received Accounting Queue Message [{emailRequestMessage}]");

            // do whatever we need to do here against this Policy object for 'Accounting' processing
