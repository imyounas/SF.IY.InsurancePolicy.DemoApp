    ...
    public partial class FirstCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_USZips", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PremiumPrice_Price = table.Column<double>(type: "float", nullable: true),
                    PremiumPrice_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsurancePolicies_Vehicles_VehicleDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsurancePolicies_VehicleDetailId",
